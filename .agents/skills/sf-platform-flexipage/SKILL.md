...
metadata:
  ...
  synthesized: true
  sources:
    - forcedotcom/sf-skills :: platform-flexipage-generate
---

# sf-platform-flexipage: FlexiPages

| Field | Value |
| --- | --- |
| Skill ID | `sf-platform-flexipage` |
| Cloud | Platform |
| Version | 1.0 |
| Synthesized | Yes — deduplicated and merged from the source(s) below |
| Sources | forcedotcom/sf-skills :: platform-flexipage-generate |

...
metadata:
  ...
  synthesized: true
  sources:
    - forcedotcom/sf-skills :: platform-custom-lightning-type-generate
---

# sf-platform-clt: Custom Lightning Types

| Field | Value |
| --- | --- |
| Skill ID | `sf-platform-clt` |
| Cloud | Platform |
| Version | 1.0 |
| Synthesized | Yes — deduplicated and merged from the source(s) below |
| Sources | forcedotcom/sf-skills :: platform-custom-lightning-type-generate |

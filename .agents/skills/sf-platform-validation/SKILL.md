...
metadata:
  ...
  synthesized: true
  sources:
    - forcedotcom/sf-skills :: platform-validation-rule-generate
---

# sf-platform-validation: Validation Rules

| Field | Value |
| --- | --- |
| Skill ID | `sf-platform-validation` |
| Cloud | Platform |
| Version | 1.0 |
| Synthesized | Yes — deduplicated and merged from the source(s) below |
| Sources | forcedotcom/sf-skills :: platform-validation-rule-generate |

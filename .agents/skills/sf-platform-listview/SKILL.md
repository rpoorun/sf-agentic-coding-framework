...
metadata:
  ...
  synthesized: true
  sources:
    - forcedotcom/sf-skills :: platform-list-view-generate
---

# sf-platform-listview: List Views

| Field | Value |
| --- | --- |
| Skill ID | `sf-platform-listview` |
| Cloud | Platform |
| Version | 1.0 |
| Synthesized | Yes — deduplicated and merged from the source(s) below |
| Sources | forcedotcom/sf-skills :: platform-list-view-generate |

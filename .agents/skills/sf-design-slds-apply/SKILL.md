...
metadata:
  ...
  synthesized: true
  sources:
    - forcedotcom/sf-skills :: design-systems-slds-apply
---

# sf-design-slds-apply: Applying SLDS

| Field | Value |
| --- | --- |
| Skill ID | `sf-design-slds-apply` |
| Cloud | Design Systems |
| Version | 1.0 |
| Synthesized | Yes — deduplicated and merged from the source(s) below |
| Sources | forcedotcom/sf-skills :: design-systems-slds-apply |

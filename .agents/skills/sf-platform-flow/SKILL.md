...
metadata:
  ...
  synthesized: true
  sources:
    - forcedotcom/sf-skills :: automation-flow-generate
    - Clientell-Ai/salesforce-skills :: sf-flow
---

# sf-platform-flow: Flow Generation

| Field | Value |
| --- | --- |
| Skill ID | `sf-platform-flow` |
| Cloud | Platform |
| Version | 1.0 |
| Synthesized | Yes — deduplicated and merged from the source(s) below |
| Sources | forcedotcom/sf-skills :: automation-flow-generate; Clientell-Ai/salesforce-skills :: sf-flow |
...
### Supplemental Guidance from `sf-flow` (Clientell-Ai/salesforce-skills :: sf-flow)

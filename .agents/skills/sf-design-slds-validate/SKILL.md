...
metadata:
  ...
  synthesized: true
  sources:
    - forcedotcom/sf-skills :: design-systems-slds-validate
---

# sf-design-slds-validate: Validating SLDS

| Field | Value |
| --- | --- |
| Skill ID | `sf-design-slds-validate` |
| Cloud | Design Systems |
| Version | 1.0 |
| Synthesized | Yes — deduplicated and merged from the source(s) below |
| Sources | forcedotcom/sf-skills :: design-systems-slds-validate |

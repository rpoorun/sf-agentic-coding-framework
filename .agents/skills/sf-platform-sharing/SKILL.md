...
metadata:
  ...
  synthesized: true
  sources:
    - forcedotcom/sf-skills :: platform-sharing-rules-generate
---

# sf-platform-sharing: Sharing Rules

| Field | Value |
| --- | --- |
| Skill ID | `sf-platform-sharing` |
| Cloud | Platform |
| Version | 1.0 |
| Synthesized | Yes — deduplicated and merged from the source(s) below |
| Sources | forcedotcom/sf-skills :: platform-sharing-rules-generate |

...
Both sources publish self-contained skill folders (`SKILL.md` plus optional `assets/`, `references/`, `scripts/`) following the open Agent Skills spec at https://agentskills.io/.
